...
- app/sources/: парсинг источников с Playwright (две независимые реализации), ожидание смены месяца по #evcal_cur (таймаут 10 секунд) с fallback на изменение списка ссылок.
