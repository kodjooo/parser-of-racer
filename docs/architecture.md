...
- app/sources/: парсинг источников с Playwright (две независимые реализации), для portugalrunning.com обход ссылок месяца и заход в карточки, ожидание смены месяца по #evcal_cur (polling 10 секунд, ретраи с паузой 10 секунд, debug-лог маркеров и итоговых ссылок) с fallback на изменение списка ссылок.
