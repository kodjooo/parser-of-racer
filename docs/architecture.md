...
6) Очистка листа Missing races и запись ссылок, отсутствующих в таблице (до анти-спама); лист создается автоматически при отсутствии.
